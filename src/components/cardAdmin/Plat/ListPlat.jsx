...
import { getAllPlats } from "../../../Services/admin/PlatService";

const ListPlat = ({ searchQuery }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await getAllPlats();
            ...
            <table className="table-auto w-full">
                <thead>
                    <tr className="px-2 bg-orange-light">
                        ...
                        <th className="py-2 flex items-center justify-center">Image</th>
                ...
                <tbody>
                    {currentItems.map((item, i) => (
                        <CardPlat key={i} i={i + 1} item={item} />
                    ))}
                </tbody>
            </table>
